...
externalLinks:
  - label: Playwright documentation
    ...
    description: Browser automation patterns that sit underneath many acceptance-proof runs.
  - label: GitHub pull request docs
    href: https://docs.github.com/en/pull-requests
    description: The review and merge surface where proof usually gets attached to tracked work.
featured: true
